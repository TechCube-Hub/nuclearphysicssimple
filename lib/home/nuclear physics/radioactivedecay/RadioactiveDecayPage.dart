  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Radioaktív bomlás'),
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                Column(
                  children: [
                    FloatingActionButton.small(
                              ...
                              content: Row(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: GoogleFonts.getFont('Dosis',
                                        textStyle: TextStyle(
                                            color: errorText, fontSize: error)),
                                  ),
                                ],
                              )));
                        }
                      ...
                      backgroundColor:
                          emissionNumber == 1 ? deepLightBlue : deepPurple,
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.getFont(
                            'Dosis',
                            textStyle:
                                TextStyle(color: textAtom, fontSize: indexes),
                          ),
                        ),
                      ),
                    ),
                    ...
                    FloatingActionButton.small(
                      ...
                      backgroundColor:
                          emissionNumber == 2 ? deepLightBlue : deepPurple,
                      child: Container(
                        margin: const EdgeInsets.only(bottom: 5.0),
                        child: Text(
                    ...
                    FloatingActionButton.small(
                      ...
                      backgroundColor:
                          emissionNumber == 3 ? deepLightBlue : deepPurple,
                      child: Container(
                        margin: const EdgeInsets.only(bottom: 5.0),
                        child: Text(
                    ...
                    FloatingActionButton.small(
                      ...
                      backgroundColor:
                          emissionNumber == 4 ? deepLightBlue : deepPurple,
                      child: Container(
                        margin: const EdgeInsets.only(bottom: 5.0),
                        child: Text(
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          margin: const EdgeInsets.only(top: 15.0, left: 15.0),
                          child: Text(
                            relative_mass.isNotEmpty && emissionNumber != null
                      ...
                      Expanded(
                        child: Container(
                          alignment: Alignment.center,
                          child: Text(
                            license_number.isNotEmpty && emissionNumber != null
                                ? periodicTable[
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                    ...
                    hint: Text('A kiindulási anyag atommagja',
                        style: TextStyle(color: textAtom, fontSize: itemsDrp)),
                    items: drpPeriodicTable.map(buildMenuItem).toList(),
                    onChanged: (value) => setState(
                          () {
                            selectedItem = value!;
                            int license = drpPeriodicTable.indexOf(value) + 1;
                            emissionNumber = null;
                            name = periodicTable[license]['name'].toString();
                            relative_mass = numberForm
                                .format(periodicTable[license]['relative_mass'])
                                .toString();
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Container(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.getFont('Dosis',
                              textStyle:
                                  TextStyle(color: textInput, fontSize: input)),
                        ),
                      ),
            ...
            Container(
              margin:
                  const EdgeInsets.symmetric(vertical: 12.5, horizontal: 35.0),
              child: HorizontalSlidableButton(
                ...
                child: Container(
                  ...
                  child: Text('Tovább sugárzás',
                      style: GoogleFonts.getFont('Dosis',
                          textStyle:
                              TextStyle(color: sliderText, fontSize: slider))),
                ),
                onChanged: (position) {
                  setState(() {
